...
ワイヤ表面における$r$ 方向の電場は$\partial_r\phi\,(r = a) = -2E_0\cos\theta/(1+\epsilon_r)$, $\theta$ 方向の電場は$r^{-1}\partial_\theta\phi\,(r = a) = 2E_0\sin\theta/(1+\epsilon_r)$ でその大きさは$a$ にはよらない．また，$\epsilon_r$ が大きいものを選ぶほどその絶対値は小さくなる．
